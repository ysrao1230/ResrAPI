...
public class ExtentDemo 
{
	...
	{    
	    ...
	    ExtentHtmlReporter reporter=new ExtentHtmlReporter("../APITesting/test-output/learn_automation1.html");
	    ...
	    logger2.fail("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("C:\\Users\\ycs\\logo.jpg").build());
        
	    logger2.pass("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("C:\\Users\\ycs\\logo1.jpg").build());
